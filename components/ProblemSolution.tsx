  ...
  return (
    <section className="py-20 bg-white">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="mb-16">
          <h2 className="text-3xl font-bold text-gray-900 mb-8 border-b-4 border-orange-500 pb-4 inline-block">
            SNS運用におけるよくある課題
          </h2>
          ...
          <div className="space-y-6 text-lg">
            <div className="flex flex-col md:flex-row items-start md:items-center bg-gray-50 p-4 rounded-lg border-l-4 border-gray-400">
              ...
              <ArrowRight className="mx-4 text-orange-500 hidden md:block" />
              <ChevronDown className="my-2 text-orange-500 md:hidden" />
              <span className="font-bold text-red-600 text-xl">（導入後：平均12分／月）</span>
            </div>
            ...
            <div className="flex flex-col md:flex-row items-start md:items-center bg-gray-50 p-4 rounded-lg border-l-4 border-gray-400">
              ...
              <ArrowRight className="mx-4 text-orange-500 hidden md:block" />
              <ChevronDown className="my-2 text-orange-500 md:hidden" />
              <span className="font-bold text-red-600 text-xl">（導入後：月額1万円～）</span>
            </div>
        ...
        <div className="bg-orange-500 rounded-3xl p-8 md:p-12 text-center text-white shadow-2xl relative overflow-hidden print:bg-white print:text-black print:border print:border-gray-300">
          <div className="absolute top-0 left-0 w-full h-full bg-white opacity-5 transform -skew-x-12 scale-150 print:hidden"></div>
          
          <p className="text-orange-100 font-bold mb-4 tracking-widest relative z-10 print:text-gray-600">SNS運用超効率化AIツール</p>
          ...
          <p className="text-xl md:text-3xl font-bold bg-white text-orange-600 py-2 px-6 rounded-full inline-block relative z-10 print:bg-transparent print:text-black print:border print:border-black">
            上記の課題を解決
          </p>
