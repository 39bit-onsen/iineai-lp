...
export const Hero: React.FC = () => {
  return (
    <section className="relative bg-gradient-to-br from-white to-orange-50 pt-24 pb-16 overflow-hidden">
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 flex flex-col md:flex-row items-center">
        <div className="w-full md:w-1/2 text-center md:text-left z-10">
          ...
          <div className="bg-blue-500 text-white p-4 rounded-lg shadow-lg inline-block text-left max-w-md">
          ...
          <div className="mt-8 no-print">
            <a href="#demo" className="bg-orange-500 hover:bg-orange-600 text-white font-bold py-4 px-10 rounded-full shadow-xl transition-transform transform hover:scale-105 inline-block text-xl">
               詳細資料ダウンロード
            </a>
          </div>
        </div>
            ...
            <div className="relative w-[300px] h-[600px] bg-black rounded-[3rem] border-8 border-gray-800 shadow-2xl overflow-hidden">
                ...
                <div className="w-full h-full bg-white pt-10 px-4 overflow-y-auto no-scrollbar">
                    ...
                    <div className="bg-white border rounded-xl shadow-sm mb-4 p-4">
                         <div className="w-full h-40 bg-orange-100 rounded-lg mb-2 flex items-center justify-center">
                ...
                <div className="absolute bottom-20 -right-12 w-24 h-24 bg-orange-200 opacity-50 rounded-full animate-ping"></div>
            </div>
            <div className="absolute top-1/2 left-1/2 transform -translate-x-1/2 -translate-y-1/2 w-[500px] h-[500px] bg-orange-400 rounded-full opacity-10 filter blur-3xl -z-10"></div>
        </div>
      </div>
    </section>
  );
